...
`;
        var html = html + `
                  <div class="ms-Table-row">
                  <span class="ms-Table-cell ms-fontWeight-semibold">TotalCount Last 30 Days</span>
                  <span id="last30" class="ms-Table-cell">`;
            html = html + entry.value.length + "</span ></div >";
            var html = html + `
                  <div class="ms-Table-row">
                  <span class="ms-Table-cell ms-fontWeight-semibold">TotalCount Last 7 Days</span>
                  <span id="last7" class="ms-Table-cell">`;
            ...
            var html = html + `
              <div class="ms-Table-row">
              <span class="ms-Table-cell"></span>
              <span class="ms-Table-cell"  style="font-size: 14px;">Positive &#x1f603;</span>
              <span class="ms-Table-cell"  style="font-size: 14px;">Negative &#x1f641;</span>
              </div>
`;
            var html = html + `
                  <div class="ms-Table-row">
                  <span class="ms-Table-cell ms-fontWeight-semibold">Last 7 Days</span>
                  <span id="pCount7" class="ms-Table-cell" style="text-align:center;">`;
            html = html + Last7Positive + "</span >";  
            html = html + "<span id=\"nCount7\" class=\"ms-Table-cell\" style=\"text-align:center;\">" + Last7Negative + "</span ></div >";  
            var html = html + `
                  <div class="ms-Table-row">
                  <span class="ms-Table-cell ms-fontWeight-semibold">Last 30 Days</span>
                  <span id="pCount" class="ms-Table-cell" style="text-align:center;">`;
