...
'    </ItemShape>' +
'   <IndexedPageItemView MaxEntriesReturned="1000" Offset="0" BasePoint="Beginning" />' +
'   <ParentFolderIds>' +
'          <t:DistinguishedFolderId Id="contacts" />' +
'   </ParentFolderIds>' +
'   <QueryString>@bedrock.com</QueryString>' +
'   </FindItem>';
...
function callback(asyncResult) {   
    ...
    $('#Req').text(asyncResult.value);
    var values = doc.getElementsByTagName("t:TotalCount");
    $('#OWAView').text(values.length);
